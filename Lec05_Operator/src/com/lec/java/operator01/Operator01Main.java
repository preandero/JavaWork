...
public class Operator01Main {
	...
	public static void main(String[] args) {
		...
		System.out.println("바꾸기 전 num3 = " + num3);
		System.out.println("바꾸기 전 num4 = " + num4);
		
		temp = num3;
		num3 = num4;
		num4 = temp;
		
		System.out.println("바꾼 후 num3 = " + num3);
		System.out.println("바꾼 후 num4 = " + num4);
