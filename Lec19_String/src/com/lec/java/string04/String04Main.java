...
public class String04Main {
	...
	public static void main(String[] args) {
		...
		StringTokenizer token3 = new StringTokenizer(str4 , "-");
...
//
//		String[] to = expr.split("\\s+");
//		
//		StringTokenizer tok = new StringTokenizer(Arrays.toString(to),"(,),-,+,/,*",true);
//		
