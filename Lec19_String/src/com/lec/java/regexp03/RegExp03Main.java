...
public class RegExp03Main {
	...
	public static void main(String[] args) {
		...
		arrInput = new String[] {
				...
				"xbz",				
				"xyyz x1y xyyyy xxxyyyyxxxyxxyxxyxyxyxyx"
		...
		regex = "[abc]";  // a 또는 b 또는 c중의 한 문자에 매
		arrInput = new String[] {
				"able", //2 a, b
				"bible", // 2 b ,b
				"cable", //3 c , a, b
		...
		regex = "[abc]+";
		regex = "[a-z]+"; // a부터 z까지 문자 1개 이상 
		arrInput = new String[] {
				"abc100",
				"abcDefGHIUJ-KLM123opQrstuz"
			};
		regex = "[a-zA-Z]+"; //소문자나 대문자중 
		regex = "[a-zA-Z0-9]+";
		regex = "[a-zA-Z0-9-]+";
		
		regex = "^[1-9][0-9]{1}$"; // 자연수에 대한 정규 표현
