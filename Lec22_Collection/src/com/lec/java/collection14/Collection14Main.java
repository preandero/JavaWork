...
public class Collection14Main {
	...
	public static void main(String[] args) throws ParseException {
		...
		List<String> arrList = Arrays.asList(arr); // 배열 ---> List<> 변환 ( List<> 의 toArray() 의 반대)
...
//		if(this.point > o.point) return 0; // 내가 더 크면 양수
//		
//		return 0; // 같으면 0
		// 점수 내림차순
...
// Student 를 이름(name) 오름차순 으로 정렬해줄 수 있는 Comparator<> 제공
...
//Student 를 이름(name) 내림차순 으로 정렬해줄 수 있는 Comparator<> 제공
