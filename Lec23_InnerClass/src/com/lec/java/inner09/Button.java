...
public class Button {
	...
	public static interface OnDbClickListener{
		void onDbClick(); // 더블클릭 했을때 동작, 추상메소드
	...
	// 리스너 장착 메소드
	public Button setOnDbClickListener(OnDbClickListener DbClickListener) {
	...
	public void actionDblClick() {
		...
		if(DbClickListener != null) {
			DbClickListener.onDbClick();  // 장착된 리스너 수행!
