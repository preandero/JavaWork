...
public class Method01Main {
	...
	public static void main(String[] args) {
		...
		com.lec.java.method01.Method01Main.sayAge(33);

		System.out.println();

		sayHello2("김우경", 25);
		// 정의되어 있는 매개변수 리스트와 다르게 호출하려고 하면
 ...
 * 
 * 디버깅 : step into : 현재 디버깅 위치의 메소드 호출 내부 코드 진입 step out (step return) : 현재
 * 디버깅진행중인 메소드 return 까지 진행후 호출한 측으로 돌아감 resume : 다음 breakpoint 까지 쭈욱 진행
 */
