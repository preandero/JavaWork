...
public class BoardValidator implements Validator {
    ...
    // 이 Validator가 제공하는 Class의 인스턴스(clazz)를 유효성 검사할 수 있는가?
    @Override
    public boolean supports(Class<?> clazz) {
        // 검증 할 객체의 클래스 타입인지 확인 : WriteDTO = clazz; 가능 여부.
