...
public class DateTime01Main {
	...
	public static void main(String[] args) throws Exception {
		...
		int year = now.getYear() + 1900; // 1900년 이후 경과 년도
		int month = now.getMonth() + 1; // 0이 1월 11이 12월
		int day = now.getDate(); // 날짜
		int weekDay = now.getDay(); // getDay = 요일, 일요일이 0
...
//		System.out.println(baseTime);
		...
		String time = String.format("%02d:%02d:%02d.%d", hr, min, sec, Millis);
